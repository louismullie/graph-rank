...
class GraphRank::TextRank
  ...
  # Default English stop-word list. update october 27: not using now that we have pos filtering and also it includes non stop words like 'system' !
  ...
  def initialize(ngram_size=1, damping=nil, convergence=nil)
